...
public class TrajectoryPlanner {
    ...
    public ArrayList<Point> estimateLaunchPoint_1(Rectangle slingshot, Point targetPoint) {
    ...
    public ArrayList<Point> estimateLaunchPointMaximum(Rectangle slingshot, Point targetPoint) {
